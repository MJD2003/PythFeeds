...
export default function StocksError({
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-24 text-center">
      ...
      <h2 className="text-xl font-bold mb-2" style={{ color: "var(--cmc-text)" }}>Failed to load stocks</h2>
      <p className="text-sm mb-6" style={{ color: "var(--cmc-neutral-5)" }}>
        {error.message || "Could not fetch stock data. The backend may be offline."}
      </p>
      <button
        onClick={reset}
