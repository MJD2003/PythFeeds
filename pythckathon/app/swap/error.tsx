...
export default function SwapError({
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-24 text-center">
      ...
      <h2 className="text-xl font-bold mb-2" style={{ color: "var(--cmc-text)" }}>Swap Error</h2>
      <p className="text-sm mb-6" style={{ color: "var(--cmc-neutral-5)" }}>
        {error.message || "Failed to load the swap page. Check your connection and try again."}
      </p>
      <button
        onClick={reset}
